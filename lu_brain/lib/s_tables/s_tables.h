...
// 
	...
	static Lu_S_Col lu_s_col__init(
		Lu_S_Col self, 
		Lu_S_Table s_table,
		Lu_Mem mem, 
		lu_size cell_size, 
	...
	static void lu_s_col__deinit(Lu_S_Col self);
	...
	static inline Lu_N_Link_Mem lu_s_col__get_link_mem(Lu_S_Col self)
	{
		lu__debug_assert(self);
	...
	static inline Lu_N_Cell lu_s_col__get_null_cell(Lu_S_Col self)
	{
		lu__debug_assert(self);
	...
	static inline Lu_N_Cell lu_s_col__get_cell_by_ix(Lu_S_Col self, lu_size cell_ix)
	{
		lu__assert(self);
		lu__assert(cell_ix < self->cells_size);
	...
	static inline void lu_s_col__realloc(Lu_S_Col self);

	static inline Lu_N_Cell lu_s_col__alloc_n_cell(Lu_S_Col self)
	{
		lu__assert(self);
	...
	static inline void lu_s_col__find_n_cell(
		Lu_S_Col self, 
		union lu_n_addr addr, 
		Lu_N_Cell* p_n_cell
	)
	{
		Lu_N_Cell n_cell = lu_s_col__get_cell_by_ix(self, addr.cell_ix);
	...
	static inline void lu_s_col__print_net_stats(Lu_S_Col self)
	{
		lu__debug(
	...
	static inline void lu_s_col__collect_net_stats(Lu_S_Col self, Lu_N_Table_Net_Stats ts)
	{
		++ts->column_count;
	...
	static inline void lu_s_col__print_mem_stats(Lu_S_Col self)
	{
		lu__debug("\nREALL n_col ");
		lu_s_col__print_net_stats(self);
		lu__debug(" ");
		lu_s_layer_base__print_basic_info(lu_s_table__get_layer(self->s_table));
	}
