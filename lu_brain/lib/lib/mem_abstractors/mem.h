...
// Lu_Mem
	...
	#define mem_temp_free(p) lu_g_mem->free(lu_g_mem, p, __func__, __FILE__, __LINE__)
	#define mem_temp_table_create(r_size, t_size, p, f) lu_g_mem->table_create(lu_g_mem, r_size, t_size, p, f, __func__, __FILE__, __LINE__)
