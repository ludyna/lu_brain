...
// W_Rec
	...
	// w_rec.lu
	static W_Rec w_rec_create(Lu_W mem, S_Rec s_rec);
...
// Lu_W
	...
	// lu_w.lu
	static Lu_W lu_w_init(Lu_W self, Lu_Brain brain);
	static void lu_w_deinit(Lu_W self);
	static void lu_w_reset(Lu_W self);

	static W_Rec lu_w_rec_get(Lu_W self, lu_size rec_id);

	static void lu_w_save_async(Lu_W self, Lu_Story story);

	// static void lu_w_propagate(Lu_W self, 
