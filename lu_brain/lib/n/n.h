...
//
	...
	static inline Lu_W_Match_Cell lu_n_cell__get_w_match_cell(Lu_N_Cell self, lu_size wave_id)
	{
	...
	{
		// Lu_W_Match_Cell match_cell = lu_n_cell__get_w_match_cell(self, wave_id);
