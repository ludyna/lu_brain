...
//
	...
	static inline void lu_n_cell__set_w_mach_cell_addr(Lu_N_Cell self, lu_size wave_id, union lu_w_match_addr w_addr)
	{
	...
	{
		union lu_w_match_addr match_addr = lu_n_cell__get_w_match_cell_addr(self, wave_id);
