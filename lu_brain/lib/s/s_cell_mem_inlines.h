...
// Size increments
	...
	static inline lu_size lu_s_cell_mem_rec_cells_size_inc(Lu_S_Cell_Mem self, lu_size s)
	{
 	...
 	static inline lu_size lu_s_cell_mem_seq_nx_cells_size_inc(Lu_S_Cell_Mem self, lu_size s)
	{
		self->seq_cells_nx_size += s;
		return self->seq_cells_nx_size;
	}
	...
	static inline lu_size lu_s_cell_mem_story_nx_cells_size_inc(Lu_S_Cell_Mem self, lu_size s)
	{
		self->story_nx_cells_size += s;
		return self->story_nx_cells_size;
	}
