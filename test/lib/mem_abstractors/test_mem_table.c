...
void test_mem_table1(void)
{
    ...
    TEST_ASSERT( ((Lu_Mem_Table_Perm)mt)->mem_stack == (Lu_Mem_Perm) mem );
    ...
    Test1 l2 = (Test1) lu_mem_record_alloc(mt);
    ...
    Test1 l3 = (Test1) lu_mem_record_alloc(mt);
    ...
    lu_mem_record_free(mt, (lu_p_byte) l3);
    ...
    lu_mem_record_free(mt, (lu_p_byte) l2);
    ...
    l2 = (Test1) lu_mem_record_alloc(mt);
    l1 = (Test1) lu_mem_record_alloc(mt);
    ...
    lu_user_assert_off();
    Test1 l4 = (Test1) lu_mem_record_alloc(mt);
    lu_user_assert_on();
    
    TEST_ASSERT(l4 == NULL);

    lu_mem_record_free(mt, (lu_p_byte) l4);
    lu_mem_record_free(mt, (lu_p_byte) l3);
    lu_mem_record_free(mt, (lu_p_byte) l2);
    lu_mem_record_free(mt, (lu_p_byte) l1);
