...
void test_lu_data_create_via_shift(void)
{
	...
	data_1 = lu_data_create_via_shift(g_mem_temp, &data_0, 1, 0);
	...
	data_1 = lu_data_create_via_shift(g_mem_temp, &data_0, 0, -1);
	...
	data_1 = lu_data_create_via_shift(g_mem_temp, &data_0, 1, 1);
